...
def run():
    ...
    print('Desarrolladores', all_python_devs)
    ...
    all_adults = list(filter(lambda i: i['age'] > 18, DATA))
    all_adults = list(map(lambda i: i['name'], all_adults))
    print('Adultos: ', all_adults)

    old_people = list(map(lambda i: i | {'old': i['age'] > 70}, DATA))

    print('Adultos: ', old_people)
